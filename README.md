...
| [HR дашборд](https://github.com/MariaStarchenko/pet_projects/tree/main/HR_dashboard) | HR | Выгрузка данных; расчет мер на DAX; создание макета дашборда; визализация данных и верстка дашборда; настройка срезов | `PowerBI`, `PowerQuery`, `DAX`|
...
| [Курс "Симулятор SQL" ](https://github.com/MariaStarchenko/pet_projects/tree/main/SQL_simulator_karpov_course) | SQL запросы | В рамках симулятора было решено 100+ задач, направленных на выборку данных с использованием базового и продвинутого функционала PostgreSQL | `SQL`, `PostgreSQL`, `Redash`|
